...
parser.add_argument('--notion_page_id',
                    default="75277c1182c14f3495fbf973234c92c3", help='Notion page ID')
parser.add_argument(
    '--url', default="https://assembly.webcast.go.kr/main/player.asp?xcode=33&xcgcd=DCM00003321410A401&", help='URL to monitor')
